...
j<-rdirichlet(1,c(0.273*892955,0.193*892955,0.25*892955,0.284*892955))
ACD4<-j[1,1]#*0.1   #<200
Params[2,k]<-ACD4
...
G<-rbeta(1,Bestparam[7]*892955, 1000) #Population growth rate 1/1000 anually
Params[7,k]<-G 
...
mVIH235<-rbeta(1,62/52, 7482/52) #Alejos et al Medicine 2016
Params[8,k]<-mVIH235
mVIH35<-rbeta(1,79/52, 19450/52)   #Alejos et al Medicine 2016
Params[9,k]<-mVIH35
mAIDS<-rbeta(1,226/52, 10051/52)    #Parastu et al PLOSone 2018
Params[10,k]<-mAIDS
Cvh<-invgamma(55, 7.5) #Partner change rate in the very high group 18-123/year Nichols et al. 2016
Params[11,k]<-Cvh
Ch<-invbeta(10, 3.5)     #Partner change rate in the high group 5-18/year Nichols et al. 2016
Params[12,k]<-Ch
Cl<-invbeta(2.5, 1.8)    #Partner change rate in the low group 0.5-5/year Nichols et al. 2016
Params[13,k]<-Cl
Cvl<-invbeta(0.25, 0.25)  #Partner change rate in the very low group 0.04-0.5/year Nichols et al. 2016
Params[14,k]<-Cvl
j1<-rdirichlet(1,c(0.1*892955,0.4*892955,0.3*892955,0.2*892955))
