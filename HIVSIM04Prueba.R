...
for (t in 1:years){
  for (j in 2:Age){
    if (t>=2 & j<85){
      S0vh[1,j]<-S0vh[52,j-1]
      I1vh[1,j]<-I1vh[52,j-1]
      I2vh[1,j]<-I2vh[52,j-1]
      I3vh[1,j]<-I3vh[52,j-1]
      I4vh[1,j]<-I4vh[52,j-1]
      I5vh[1,j]<-I5vh[52,j-1]
      I6vh[1,j]<-I6vh[52,j-1]
      I7vh[1,j]<-I7vh[52,j-1]
      I8vh[1,j]<-I8vh[52,j-1]
      AIDSvh[1,j]<-AIDSvh[52,j-1]
      ...
      I7l[1,j]<-I7l[52,j-1]
      I8l[1,j]<-I8l[52,j-1]
      AIDSl[1,j]<-AIDSl[52,j-1]
      
      S0vl[1,j]<-S0vl[52,j-1]
      I1vl[1,j]<-I1vl[52,j-1]
      I2vl[1,j]<-I2vl[52,j-1]
      I3vl[1,j]<-I3vl[52,j-1]
      I4vl[1,j]<-I4vl[52,j-1]
      I5vl[1,j]<-I5vl[52,j-1]
      I6vl[1,j]<-I6vl[52,j-1]
      I7vl[1,j]<-I7vl[52,j-1]
      I8vl[1,j]<-I8vl[52,j-1]
      AIDSvl[1,j]<-AIDSvl[52,j-1]
      
      #Compartments on PrEP
      #Very high risk
      
      S0pvh[1,j]<-S0pvh[52,j-1]
      I1pvh[1,j]<-I1pvh[52,j-1]
      I2pvh[1,j]<-I2pvh[52,j-1]
      I3pvh[1,j]<-I3pvh[52,j-1]
      I4pvh[1,j]<-I4pvh[52,j-1]
      I5pvh[1,j]<-I5pvh[52,j-1]
      I6pvh[1,j]<-I6pvh[52,j-1]
      I7pvh[1,j]<-I7pvh[52,j-1]
      I8pvh[1,j]<-I8pvh[52,j-1]
      AIDSpvh[1,j]<-AIDSpvh[52,j-1]
      
      #high risk
      S0ph[1,j]<-S0ph[52,j-1]
      I1ph[1,j]<-I1ph[52,j-1]
      I2ph[1,j]<-I2ph[52,j-1]
      I3ph[1,j]<-I3ph[52,j-1]
      I4ph[1,j]<-I4ph[52,j-1]
      I5ph[1,j]<-I5ph[52,j-1]
      I6ph[1,j]<-I6ph[52,j-1]
      I7ph[1,j]<-I7ph[52,j-1]
      I8ph[1,j]<-I8ph[52,j-1]
      AIDSph[1,j]<-AIDSph[52,j-1]
